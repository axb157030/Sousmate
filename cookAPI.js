	...
	// Get random recipe input random meal title and corresponding picture into SousHome.html
	...
	// Get random recipe input random meal title and corresponding picture into SousHome.html and request and save the corresponding recipe of meal from the MealDB API
	$.getJSON('https://www.themealdb.com/api/json/v1/1/random.php', function (data) {
...
// Save the corresponding recipe of meal if the #recipeSubmit button in SousHOme.html is clicked
