/*sousIndexAni.js simply animates the element with id "danClock", it is the element that holds the clock picture and text to the right of it. When the user is at a specfic position
in the webpage the danClock element appears. It also adds animation to the index menu fixed at the top of the screen like sousmenu.js does  */
